...
- **來源涵蓋**：信用卡 3 家、電支 3 家（含 iPASS MONEY）、PTT 省錢版 1 個（LLM 抽取、標 web_unverified）。LINE Pay（優惠全在 app 內 SPA）、玉山（WAF 擋非瀏覽器請求）需 headless browser，列為後續。
